...
func TestT(t *testing.T) {
	query := `{"workflow":[{"type":"filter","filters":[{"type":"oneOf","field":"GW_2EGYYO6PYYXXQHBP","value":["重庆市"]}]},{"type":"transform","transform":[{"key":"gw_count_fid","expression":{"op":"one","params":[],"as":"gw_count_fid"}}]},{"type":"view","query":[{"op":"aggregate","groupBy":["GW_12QTTUVRJQ","GW_2EGYYO6PYYXXQHBP"],"measures":[{"field":"gw_count_fid","agg":"sum","asFieldKey":"gw_count_fid_sum"}]}]}]}`
